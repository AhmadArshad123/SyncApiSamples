...
public class Data {
     ...
     * @param breeds
     */
    public Data(List<Stat> stats, List<Province> province, List<District> districts, List<Tehsil> tehsils, List<UnionCouncil> unionCouncils, List<Village> villages, List<Animal> animals, List<Species> species, List<Breed> breeds, List<PremesisType> premesisTypes) {
        super();
        this.stats = stats;
